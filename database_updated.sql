...
CREATE TABLE IF NOT EXISTS workshop (
    ...
    materi_pdf_path VARCHAR(255),
    status ENUM('aktif','nonaktif') DEFAULT 'aktif',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);

-- Tabel pendaftar workshop
CREATE TABLE IF NOT EXISTS workshop_pendaftar (
    id VARCHAR(20) PRIMARY KEY,
...
-- Update database untuk menambahkan kolom butuh_kartu_pelajar
-- Jalankan query ini jika kolom belum ada
