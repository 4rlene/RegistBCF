...
<head>
    ...
    <title>Blue Creative Fest - Lomba Kreatif untuk SMP</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top">
        <div class="container">
            <a class="navbar-brand fw-bold" href="index.php">
                <i class="fas fa-trophy text-primary"></i> Blue Creative Fest
            </a>
                        ...
                        <div class="lomba-actions">
                            <?php
                                ...
                                if (!empty($ws['materi_pdf_path'])) {
                                    ...
                                    $detailHref = 'workshop_register.php?workshop_id=' . urlencode($ws['id']);
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="footer-widget">
                        <h5 class="footer-title">
                            <i class="fas fa-trophy"></i> Blue Creative Fest
                        </h5>
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <p class="copyright-text">
                            &copy; 2024 Blue Creative Fest. All rights reserved.
                        </p>
                </div>
